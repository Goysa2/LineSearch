################################################################################
# This is an adaptation of an old version of the line search provided by
# LineSearches.jl. This version is designed to work within our framework.
# For a better and updated version of the Hager and Zhang line search algorithm
# refer to : https://github.com/JuliaNLSolvers/LineSearches.jl/blob/master/src/hagerzhang.jl
################################################################################
...
function _hagerzhang2!(h :: LineModel,
                       stop_ls,
                       f :: Real,
                       slope :: Real,
                       ∇ft :: Array{T,1};
    ...
    if !(isfinite(phic) && isfinite(dphic))
        ...
        state = LSAtT(zero(T))
        stop_ls.meta.nb_of_stop = iterfinite
        stop_ls.meta.optimal = false
        return state, false
...
# phi
function secant22!(df::AbstractNLPModel,
                   x::Array,
                   s::Array,
                   xtmp::Array,
                   lsr::LineSearchResults{T},
...
function bisect2!(df::AbstractNLPModel,
                  x::Array,
                  s::Array,
                  xtmp::Array,
                  lsr::LineSearchResults{T},
